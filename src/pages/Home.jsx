...
return (
    <div id="home">
        ...
        <div id="homeContainer" className='row pt-4 pt-sm-5'>

            <div className="hero-left col-xl-7 mb-5 mb-xl-0">
                <div className="pe-xxl-4">
                    <h1 className="mt-3 lh-base">
                        Hello. My name is <br /><span className="myName text-warning">Leo Gurgel</span>, and I am a <br /><span className="webDev">Web Developer</span> who works with: <br/><span className="typing-animation"></span>
                    </h1>
                    <a className='btn btn-lg btn-outline-dark work-button' >Lets work together!</a>
                </div>
